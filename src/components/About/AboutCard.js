      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />I am pursuing Bachelors in Electrical Engineering from Sardar Vallabhbhai National Institute of Technology (NIT Surat)
            <br />
            <br />
          ...
          <footer className="blockquote-footer">Avni</footer>
        </blockquote>
      </Card.Body>
    </Card>
  );
